    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-[#fbfbfb]">
            <div className="shadow-xl/30 w-100 rounded-md bg-white">
                <div className="flex justify-center font-bold text-4xl mt-5 mb-3">Sign In</div>
                <div className="flex justify-center text-gray-500">Enter your credentials to access your</div>
                ...
                <div className="bg-gray-900  w-785/1000 mt-6 ml-10 text-md h-10 flex items-center justify-center rounded border-1 border-[#a0a3a3] cursor-pointer active:bg-gray-500"><div className="flex text-[#eaeaea] items-center justify-center h-full w-full">Sign In</div></div>
                <div className="flex justify-center mt-5 mb-7 pr-2">
                    ...
                    <div onClick={() => {
                        navigate("/signup");
                    }}  className="ml-1 underline cursor-pointer active:text-gray-500">Sign Up</div></div>
            </div>
        </div>
    )
}